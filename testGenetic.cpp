...
int main()
{
    ...
    //crossoverSelectionFunctionsMatrix[2]
    ...
    // crossoverSelectionFunctionsMatrix[0] = &MatrixTSPInstance::crossoverSelection;
    ...
    for (unsigned i = 0, j = 0, k = 0, l = 0, m = 0; i <= 3; m++)
    {
        if (m == 3)
        {
            m = 0;
    ...
    // for (int i = 0; i < 100; i++)
    // {
    //     matrixInstance.solveGenetic(CLOCKS_PER_SEC * 60, 123, false, 100, 15, 100, startingPopulationsMatrix[variants[i][0]], 
    ...
    matrixInstance.solveGenetic(CLOCKS_PER_SEC * 60, 123, false, 100, 15, 100, startingPopulationsMatrix[0], 
